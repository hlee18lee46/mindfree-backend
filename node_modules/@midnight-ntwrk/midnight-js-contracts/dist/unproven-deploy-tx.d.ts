...
export declare function createUnprovenDeployTxFromVerifierKeys<C extends Contract<undefined>>(verifierKeys: [ImpureCircuitId<C>, VerifierKey][], coinPublicKey: CoinPublicKey, options: DeployTxOptionsBase<C>): UnsubmittedDeployTxData<C>;
export declare function createUnprovenDeployTxFromVerifierKeys<C extends Contract>(verifierKeys: [ImpureCircuitId<C>, VerifierKey][], coinPublicKey: CoinPublicKey, options: DeployTxOptionsWithPrivateState<C>): UnsubmittedDeployTxData<C>;
/**
