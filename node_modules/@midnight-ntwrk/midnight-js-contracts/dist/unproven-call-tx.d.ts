...
export declare function createUnprovenCallTxFromInitialStates<C extends Contract<undefined>, ICK extends ImpureCircuitId<C>>(options: CallOptionsWithProviderDataDependencies<C, ICK>): UnsubmittedCallTxData<C, ICK>;
export declare function createUnprovenCallTxFromInitialStates<C extends Contract, ICK extends ImpureCircuitId<C>>(options: CallOptionsWithPrivateState<C, ICK>): UnsubmittedCallTxData<C, ICK>;
/**
