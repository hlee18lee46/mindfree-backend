 ...
 *
 * @param possibleBech32 The input string, which can be a Bech32m-encoded public key or a hex string.
 * @param zswapNetworkId The network ID used for decoding the Bech32m format.
...
export { assertDefined, assertIsContractAddress, assertIsHex, assertUndefined, fromHex, isHex, parseCoinPublicKeyToHex, parseHex, toHex };
